...
def load_config() -> Config:
    return Config(
        ...
        rss_interval_seconds=_env_int("RSS_INTERVAL_SECONDS", 300),
        rss_jitter_seconds=_env_int("RSS_JITTER_SECONDS", 20),
        fulltext_enabled=_env_bool("FULLTEXT_ENABLED", True),
        nodeseek_cookie=_env_str("NODESEEK_COOKIE", ""),
        nodeseek_html_min_interval_seconds=_env_int("NODESEEK_HTML_MIN_INTERVAL_SECONDS", 300),
